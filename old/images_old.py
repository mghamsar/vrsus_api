...
class Images:
    ...
    #     #db.execute("SELECT id,name,category from images where type='category' ORDER BY position")
    ...
    #         addquery = "UPDATE images SET event_name='"+eventname+"' WHERE name='"+imagename+"';"
